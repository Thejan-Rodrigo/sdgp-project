...
export default function TeacherSideBar() {
    return (
        <div className=" py-28 px-5 bg-pink-200 w-auto h-auto">



            <div class="md:flex">
                <ul class="flex-column space-y space-y-11 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
                    <li>
                        <a href="#" class="inline-flex items-center px-4 py-4 text-white bg-blue-700 rounded-lg active w-full dark:bg-blue-600" aria-current="page">
                    ...
                    <li>
                        <a href="#" class="inline-flex items-center px-4 py-4 rounded-lg hover:text-gray-900 bg-orange-200 hover:bg-gray-100 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                ...
                <div class=" p-5 bg-yellow-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
