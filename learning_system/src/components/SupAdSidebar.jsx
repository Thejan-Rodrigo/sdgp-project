...
const Sidebar = () => {
  ...
  const menuItems = [
    { icon: <FaBell />, text: 'Announcements', path: '/superadminannouncement' },
    { icon: <FaSchool />, text: 'Add School', path: '/addSchool' },
    { icon: <FaUserCog />, text: 'Add Admin', path: '/addadmin' },
    { icon: <FaBook />, text: 'Add Lessons', path: '/addlesson' },
    { icon: <FaQuestionCircle />, text: 'Q&A Management', path: '/SuperAdminq&a' },
    { icon: <FaHeadphones />, text: 'Learing', path: '/addLearningPage' }
  ];
