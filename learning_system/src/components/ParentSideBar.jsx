...
const Sidebar = () => {
    ...
    const menuItems = [
        { icon: <FaBullhorn />, text: 'Announcement', path: '/studentannouncement' },
        { icon: <FaCalendar />, text: 'Meeting', path: '/parentmeeting' },
        { icon: <FaUserGraduate />, text: 'Student Profile', path: '/studentprofile' },
        { icon: <FaQuestionCircle />, text: 'Q&A', path: '/parentq&a' },
