...
const Sidebar = () => {
  ...
  const menuItems = [
    { icon: <FaBell />, text: 'Announcements', path: '/adminannouncement' },
    { icon: <FaUserPlus />, text: 'Register', path: '/registering' },
    { icon: <FaUserGraduate />, text: 'Student Profile', path: '/adminSProfile' },
    { icon: <FaQuestionCircle />, text: 'Q&A', path: '/Adminq&a' }
  ];
  ...
  return (
    <div className="fixed w-64 h-screen bg-white shadow-lg flex flex-col">
